    ...
    <div className="flex h-screen bg-canvas">
      ...
      <div className="w-80 bg-surface-card border-r border-hairline overflow-y-auto">
        <div className="p-4 border-b border-hairline">
          <h1 className="text-lg font-display font-semibold text-ink">Chat</h1>
        </div>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <p className="font-medium text-ink">{room.instructor.fullName}</p>
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="p-4 bg-surface-card border-b border-hairline flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div>
                <p className="font-medium text-ink">{selectedRoom.instructor.fullName}</p>
                <p className="text-sm text-muted">{selectedRoom.course.title}</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              {onlineUsers.has(selectedRoom.instructorId) ? (
